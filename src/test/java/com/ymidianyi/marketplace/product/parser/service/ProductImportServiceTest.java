...
class ProductImportServiceTest {
    ...
    void shouldPersistAllFieldsOnFirstImport() {
        ProductExportFileDto dto = exportDto(List.of(fullProduct()));

        service.importProducts(dto, "products_PARTNER-A_2026-03-23.json");
    ...
    void shouldUpdateExistingProductOnDuplicateSku() {
        ...
        ProductDto updated = new ProductDto(
                ...
                "New Brand",
                List.of("Seasonal"),
                "https://img.example.com/apple2.jpg");
    ...
    void shouldReuseExistingCategoryAcrossProducts() {
        ProductDto product1 = new ProductDto(
                ...
                null, null, null, ProductState.ACTIVE,
                null, List.of("Fruits"), null);
